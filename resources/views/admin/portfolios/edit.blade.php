                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('category') border-red-500 @enderror" 
                            ...
                            <option value="app" {{ old('category', $portfolio->category) == 'app' ? 'selected' : '' }}>App Design</option>
                            <option value="product" {{ old('category', $portfolio->category) == 'product' ? 'selected' : '' }}>App Development</option>
                            <option value="branding" {{ old('category', $portfolio->category) == 'branding' ? 'selected' : '' }}>Branding</option>
                            <option value="books" {{ old('category', $portfolio->category) == 'books' ? 'selected' : '' }}>IT Solutions</option>
                        </select>
                        @error('category')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
