...
<div class="container-fluid">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Edit Case Study</h2>
    ...
    <form action="{{ route('admin.case-studies.update', $caseStudy) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white rounded-lg shadow mb-6">
            ...
            <div id="basic-tab" class="tab-content p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="client" value="{{ $caseStudy->client }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Project URL</label>
                        <input type="url" name="project_url" value="{{ $caseStudy->project_url }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Project Date</label>
                        <input type="date" name="project_date" value="{{ $caseStudy->project_date ? $caseStudy->project_date->format('Y-m-d') : '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        ...
                        @if($caseStudy->featured_image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $caseStudy->featured_image) }}" alt="Current image" class="w-20 h-20 object-cover rounded">
                            </div>
                        @endif
                    </div>
                </div>
                <div class="mt-6">
                    ...
                    <textarea name="description" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>{{ $caseStudy->description }}</textarea>
                </div>
            </div>
            ...
            <div id="process-tab" class="tab-content p-6 hidden">
                ...
                <div id="process-container">
                    @if($caseStudy->work_process && is_array($caseStudy->work_process))
                        ...
                        <div class="process-item border border-gray-200 rounded-md p-4 mb-4">
                            <div class="flex justify-between items-center mb-4">
                                <h4 class="font-medium">Process Step {{ $index + 1 }}</h4>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="work_process[{{ $index }}][title]" value="{{ is_array($process) ? ($process['title'] ?? '') : '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Step Order</label>
                                    <input type="number" name="work_process[{{ $index }}][order]" value="{{ is_array($process) ? ($process['order'] ?? $index + 1) : $index + 1 }}" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                                </div>
                            </div>
                            <div class="mt-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Step Description</label>
                                <textarea name="work_process[{{ $index }}][description]" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md">{{ is_array($process) ? ($process['description'] ?? '') : '' }}</textarea>
                            </div>
                        </div>
                        @endforeach
                    @endif
                        ...
                        <div class="technology-item border border-gray-200 rounded-md p-4 mb-4">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" name="technologies[{{ $index }}][name]" value="{{ is_array($tech) ? ($tech['name'] ?? '') : '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="e.g., Laravel">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Icon Class</label>
                                    <input type="text" name="technologies[{{ $index }}][icon]" value="{{ is_array($tech) ? ($tech['icon'] ?? '') : '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md" placeholder="e.g., bi bi-code-slash">
                                </div>
                            </div>
                        </div>
                        @endforeach
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        @if($caseStudy->challenges_image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $caseStudy->challenges_image) }}" alt="Current challenges image" class="w-20 h-20 object-cover rounded">
                            </div>
                        @endif
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Challenges</label>
                        <textarea name="challenges" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Describe the technical, business, or design challenges encountered...">{{ $caseStudy->challenges }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        @if($caseStudy->solutions_image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $caseStudy->solutions_image) }}" alt="Current solutions image" class="w-20 h-20 object-cover rounded">
                            </div>
                        @endif
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Solutions</label>
                        <textarea name="solutions" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Describe the solutions, methodologies, and approaches used...">{{ $caseStudy->solutions }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div id="results-tab" class="tab-content p-6 hidden">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        @if($caseStudy->results_image)
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $caseStudy->results_image) }}" alt="Current results image" class="w-20 h-20 object-cover rounded">
                            </div>
                        @endif
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Results & Outcomes</label>
                        <textarea name="results" rows="6" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Describe the measurable results, performance improvements, user feedback...">{{ $caseStudy->results }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div id="testimonial-tab" class="tab-content p-6 hidden">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        @if($caseStudy->client_testimonial && is_array($caseStudy->client_testimonial) && isset($caseStudy->client_testimonial['image']))
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $caseStudy->client_testimonial['image']) }}" alt="Current client image" class="w-20 h-20 object-cover rounded">
                            </div>
                        @endif
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="client_testimonial[name]" value="{{ is_array($caseStudy->client_testimonial) ? ($caseStudy->client_testimonial['name'] ?? '') : '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="John Doe">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Client Position</label>
                            <input type="text" name="client_testimonial[position]" value="{{ is_array($caseStudy->client_testimonial) ? ($caseStudy->client_testimonial['position'] ?? '') : '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="CEO, Company Name">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Testimonial Message</label>
                        <textarea name="client_testimonial[message]" rows="4" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="The team delivered exceptional results and exceeded our expectations...">{{ is_array($caseStudy->client_testimonial) ? ($caseStudy->client_testimonial['message'] ?? '') : '' }}</textarea>
                    </div>
                    <div>
                        ...
                        <select name="client_testimonial[rating]" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                            <option value="5" {{ (is_array($caseStudy->client_testimonial) ? ($caseStudy->client_testimonial['rating'] ?? 5) : 5) == 5 ? 'selected' : '' }}>5 Stars</option>
                            <option value="4" {{ (is_array($caseStudy->client_testimonial) ? ($caseStudy->client_testimonial['rating'] ?? 5) : 5) == 4 ? 'selected' : '' }}>4 Stars</option>
                            <option value="3" {{ (is_array($caseStudy->client_testimonial) ? ($caseStudy->client_testimonial['rating'] ?? 5) : 5) == 3 ? 'selected' : '' }}>3 Stars</option>
                            <option value="2" {{ (is_array($caseStudy->client_testimonial) ? ($caseStudy->client_testimonial['rating'] ?? 5) : 5) == 2 ? 'selected' : '' }}>2 Stars</option>
                            <option value="1" {{ (is_array($caseStudy->client_testimonial) ? ($caseStudy->client_testimonial['rating'] ?? 5) : 5) == 1 ? 'selected' : '' }}>1 Star</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div id="sections-tab" class="tab-content p-6 hidden">
                ...
                <div id="sections-container">
                    @if($caseStudy->sections && is_array($caseStudy->sections))
                        ...
                        <div class="section-item border border-gray-200 rounded-md p-4 mb-4">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="sections[{{ $index }}][title]" value="{{ is_array($section) ? ($section['title'] ?? '') : '' }}" class="w-full px-3 py-2 border border-gray-300 rounded-md">
                            </div>
                            <div class="mb-4">
                                ...
                                @if(is_array($section) && isset($section['image']) && $section['image'])
                                    <div class="mt-2">
                                        <img src="{{ asset('storage/' . $section['image']) }}" alt="Current section image" class="w-20 h-20 object-cover rounded">
                                    </div>
                                @endif
                            </div>
                            <div class="mt-4">
                                <label class="block text-sm font-medium text-gray-700 mb-2">Section Content</label>
                                <textarea name="sections[{{ $index }}][content]" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md">{{ is_array($section) ? ($section['content'] ?? '') : '' }}</textarea>
                            </div>
                        </div>
                        @endforeach
                    @endif
            ...
            <div id="seo-tab" class="tab-content p-6 hidden">
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="meta_title" value="{{ $caseStudy->meta_title }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Meta Description</label>
                        <textarea name="meta_description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ $caseStudy->meta_description }}</textarea>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Meta Keywords</label>
                        <input type="text" name="meta_keywords" value="{{ $caseStudy->meta_keywords }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="flex justify-end space-x-4">
            ...
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-md">Update Case Study</button>
        </div>
    </form>
</div>

<script>
// Tab functionality (same as create form)
