        ...
        <form action="{{ route('admin.partner-hero-sections.update', $partnerHeroSection) }}" method="POST">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="our_partners_title" id="our_partners_title" value="{{ old('our_partners_title', $partnerHeroSection->our_partners_title) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                ...
                <div>
                    ...
                    <textarea name="our_partners_description" id="our_partners_description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>{{ old('our_partners_description', $partnerHeroSection->our_partners_description) }}</textarea>
                ...
                <div>
                    ...
                    <input type="text" name="worldwide_partners_title" id="worldwide_partners_title" value="{{ old('worldwide_partners_title', $partnerHeroSection->worldwide_partners_title) }}" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                ...
                <div>
                    ...
                    <textarea name="worldwide_partners_description" id="worldwide_partners_description" rows="3" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>{{ old('worldwide_partners_description', $partnerHeroSection->worldwide_partners_description) }}</textarea>
