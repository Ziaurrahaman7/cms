...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200">
            <h3 class="text-lg font-semibold text-gray-800">Edit Team Member</h3>
        </div>
        <div class="p-6">
            <form action="{{ route('admin.teams.update', $team) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mt-6">
                    ...
                    @if($team->image)
                        <div class="mt-2">
                            <img src="{{ asset('storage/teams/' . $team->image) }}" alt="Current image" class="w-32 h-32 object-cover rounded-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div class="flex items-center mt-8">
                        <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $team->is_active) ? 'checked' : '' }} class="rounded">
                ...
                <div class="flex justify-between mt-8">
                    ...
                    <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-md transition-colors">Update Team Member</button>
                </div>
            </form>
        </div>
    </div>
