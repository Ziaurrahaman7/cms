    ...
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <div id="clientReviewsCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="6000">
                  ...
                  <div class="text-center" style="padding-top: 30px;">
                    ...
                    <blockquote class="mb-0">
                      ...
                      <div class="review-text-container">
                        ...
                        @if($isLong)
                        <button class="btn btn-link p-0 mt-2 read-more-btn" style="color: #667eea; font-weight: 600; text-decoration: none; font-size: 0.9rem;">
                          <i class="bi bi-plus-circle me-1"></i>Read More
                        </button>
                        <button class="btn btn-link p-0 mt-2 read-less-btn d-none" style="color: #667eea; font-weight: 600; text-decoration: none; font-size: 0.9rem;">
          ...
          <!-- Carousel Indicators -->
          <div class="carousel-indicators" style="bottom: -80px;">
            @foreach($portfolio->client_reviews as $index => $review)
            <button type="button" data-bs-target="#clientReviewsCarousel" data-bs-slide-to="{{ $index }}" class="{{ $index === 0 ? 'active' : '' }}" style="width: 20px; height: 20px; border-radius: 50%; background: rgba(255,255,255,0.5); border: 3px solid white; box-shadow: 0 5px 15px rgba(0,0,0,0.2); margin: 0 8px; transition: all 0.3s ease;"></button>
            @endforeach
          </div>
          @endif
        </div>
